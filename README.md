# 💫 Hakkımda:
👋 Merhaba! Ben Furkan, Yazılım Mühendisliğinden mezun bir Mobile geliştiricisiyim. 🚀 SwiftUI ve ReactNative ile uygulama geliştirme konusunda tutkuluyum ve bu alanda kendimi profesyonel seviyeye taşımayı hedefliyorum. Apple ekosisteminde kullanıcı dostu ve yenilikçi uygulamalar geliştirmek benim için bir tutku.<br><br>🌱 Şu anda, ReactNative ile kullanıcı dostu arayüzler içeren mobil uygulamalar üzerinde çalışıyorum.<br><br>💡 Yeni teknolojileri öğrenmeyi, kodlamayı ve açık kaynak projelere katkıda bulunmayı seviyorum. <br><br>
